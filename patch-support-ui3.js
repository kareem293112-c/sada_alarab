...
// We'll just replace between startMarker and the Send button closing tag
const endMarker2 = '                            <Send className="w-3.5 h-3.5" />\n                          </button>\n                        </div>\n                      </div>\n                    </div>\n                  )}';

const startIndex = content.indexOf(startMarker);
const endIndex = content.indexOf(endMarker2) + endMarker2.length;
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Patched support UI 3 successfully");
} else {
