...
const targetStr = `  // Listen for Firebase auth state changes`;
...
if (content.includes(targetStr)) {
  ...
  console.log("Patched support effects 2 successfully");
} else {
  console.log("Could not find target string for support effects 2");
}
